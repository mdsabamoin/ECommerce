...
const CustomJeans = ()=>{
    ...
    const pic1url = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/61691/optimized_large_thumb_32599a_copy.jpg"
    const [photo, setPhoto] = useState(<img src={pic1url} style={{ width: "70%", height: "80%" }}/>);
    const pic2url = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/61478/optimized_large_thumb_mockup-of-a-man-wearing-a-denim-jacket-32593_copy.jpg"
    const pic3url = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/61923/optimized_large_thumb_32608a__1__copy.jpg"
    // const pic4url = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/62038/optimized_large_thumb_32611a__2__copy.jpg";
    const pic5url = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/61707/optimized_large_thumb_32605a__2__copy.jpg";
    // const pic6url = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/61685/optimized_large_thumb_mockup-of-a-cool-man-wearing-a-denim-jacket-on-the-street-32594_copy.jpg"
            ...
            <Col><Card style={{ width: '7rem' ,borderColor:"white"}}>
                <Card.Body>
                    <div><Container fluid style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", padding: 0, margin: 0 }}>
                        ...
                        <Row className="no-gutters" style={{ padding: 0, margin: 0 }}>
                            <Col className="no-padding" style={{ padding: 0, margin: 0 }}><img src={pic1url} style={{ width: "70%", height: "80%" }} onClick={() => HandlePhoto(pic1url)} /></Col>
                        </Row>
                    </Container>
                    </div>
                </Card.Body>
