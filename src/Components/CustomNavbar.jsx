...
function CustomNavbar() {
   const ctx = useContext(Context);
    ...
    return (
        <Navbar expand="md" bg="dark" variant="dark" className="bg-body-black" style={{height:"50px"}}>
                ...
                <Container  >
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <Nav.Link as={Link} to="/contact" className='fs-3 m-3 text-white'>Contact</Nav.Link>
